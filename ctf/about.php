...
<body class="imgloaded">
    ...
    <div class="jumbotron bg-transparent mb-0 pt-3 radius-0">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <h1 class="display-1 bold color_white content__title text-center"><span class="color_danger">ABOUT</span>US</h1>
                    ...
                    <div class="row justify-content-center hackerFont">
                        <div class="col-md-8">
                            ...
                            <h5 class="bold color_white pt-3">
                                About CyberHeist CTF
                            </h5>
                            <!--CyberHeist CTF is a sub event of PICT's <a href="">Impetus and Concepts</a> mega event where students partcipate from all over the world!<br> Out aim is about spreading the importance of cybersecurity in today's
                            ...
                            Cyber heist CTF challenge is a Jeopardy style web based challenge which will teach about specific  cyber  security  skills  and  techniques  such  as  Linux  commands,  SQL  injection  commands,  brute force, XSS, cryptography, steganography, programming etc. Cyber Heist will be a challenge based on the popular Netflix Spanish drama series La Casa De Papel also known as Money heist. When a contestant completes each  task,  they  will  be  heading  for  more  difficult  tasks,  which  is  considered  as  they  are  step  by  step heading towards a cyber heist which robs bitcoins from the internet. The beginning CTF levels are flowing based on how the professor plan the heist and assign tasks for the contestants in order to teach the plans. Ending levels would be much difficult so that those levels are considered as the actual heist.
                            <h5 class="bold color_white pt-3">
                                Who can play CyberHeist CTF
                            </h5>
                            CyberHeist CTF is mainly targeted for DevOps professionals that work in financial side of companies.
                            <div class="row text-center pt-5">
                                <div class="col-xl-12">
                                    <button class="btn btn-outline-danger px-3my-2 ml-0 ml-sm-1 text-left typewriter" onclick="(function(){window.location.href='login.php'})();">
                                        <h4>LET IT RIP!</h4>
                                        </button>
                                </div>
                            </div>
        ...
        <div class="navbar-nav ml-auto">
            ...
            <a href="about.php" class="p-3 text-decoration-none text-white bold bottom-nav">About</a>
        </div>
