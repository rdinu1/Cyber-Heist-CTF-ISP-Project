...
<body>
    ...
    <div class="jumbotron bg-transparent mb-0 pt-0 radius-0">
        <div class="container">
            <div class="row">
                <div class="col-xl-12  text-center">
                    <h1 class="display-1 bold color_white content__title">CHALL<span class="color_danger">ENGES</h1>
            ...
            <div class="row hackerFont">
                ...
                <div class="col-md-4 mb-3">
                    <div class="card category_web">
                        <div class="card-header " data-target="#problem_id_1" data-toggle="collapse" aria-expanded="false" aria-controls="problem_id_1">
                            Cameroon cryptographic challenge<span class="badge"></span> <span class="badge">50 points</span>
                        </div>
                        <div id="problem_id_1" class="collapse card-body">
                            <blockquote class="card-blockquote">
                                <div style="display: flex;">
                                    <h6 class="solvers">Solvers: <span class="solver_num">123</span> &nbsp;<!--<span class="color_danger">Difficulty:</span>--></h6>
                                    <div class="pl-2"><canvas style="width:80px;height:20px" id="problem_id_2_chart"></canvas></div>
                                </div>
                                <p> Enter the flag in the following format: CyberHeist_CTF{flag}
                                </p>
                                <a target="_blank" href="awareness1.php" class="btn btn-outline-secondary"><span class="fa fa-download mr-2"></span>Awareness</a>
                                <a href="level01.php" class="btn btn-outline-secondary"><span class="far fa-lightbulb mr-2"></span>Hint</a>
                ...
                <div class="col-md-4 mb-3">
                    <div class="card category_reversing">
                        <div class="card-header" data-target="#problem_id_2" data-toggle="collapse" aria-expanded="false" aria-controls="problem_id_2">
                            Valencia 1.0 linux challenge <span class="badge align-self-end">60 points</span>
                        </div>
                        <div id="problem_id_2" class="collapse card-body">
                            <blockquote class="card-blockquote">
                                <div style="display: flex;">
                                    <h6 class="solvers">Solvers: <span class="solver_num">115</span> &nbsp;<!--<span class="color_danger">Difficulty:</span>--></h6>
                                    <div class="pl-2"><canvas style="width:80px;height:20px" id="problem_id_3_chart"></canvas></div>
                                </div>
                                <p> Enter the flag in the following format: CyberHeist_CTF{flag}
                                </p>
                                <a target="_blank" href="awareness2.php" class="btn btn-outline-secondary"><span class="fa fa-download mr-2"></span>Awareness</a>
                                <a href="level02.php" class="btn btn-outline-secondary"><span class="far fa-lightbulb mr-2"></span>Hint</a>
                                <div class="input-group mt-3">
                                    <div class="custom-control custom-radio">
                ...
                <div class="col-md-4 mb-3">
                    <div class="card category_pwning">
                        <div class="card-header" data-target="#problem_id_3" data-toggle="collapse" aria-expanded="false" aria-controls="problem_id_3">
                            Al catraz steganography challenge<span class="badge align-self-end">110 points</span>
                        </div>
                        <div id="problem_id_3" class="collapse card-body">
                            <blockquote class="card-blockquote">
                                <div style="display: flex;">
                                    <h6 class="solvers">Solvers: <span class="solver_num">46</span> &nbsp;<!--<span class="color_danger">Difficulty:</span>--></h6>
                                    <div class="pl-2"><canvas style="width:80px;height:20px" id="problem_id_1_chart"></canvas></div>
                                </div>
                                <p> Enter the flag in the following format: CyberHeist_CTF{flag}
                                </p>
                                <a target="_blank" href="awareness3.php" class="btn btn-outline-secondary"><span class="fa fa-download mr-2"></span>Awareness</a>
                                <a href="level03.php" class="btn btn-outline-secondary"><span class="far fa-lightbulb mr-2"></span>Hint</a>
                                <div class="input-group mt-3">
                                    <div class="custom-control custom-radio">
                ...
                <div class="col-md-4 mb-3">
                    <div class="card category_web">
                        <div class="card-header" data-target="#problem_id_4" data-toggle="collapse" aria-expanded="false" aria-controls="problem_id_4">
                            Chernobyl 1.0 web Challenge <span class="badge"></span> <span class="badge">50 points</span>
                        </div>
                        <div id="problem_id_4" class="collapse card-body">
                            <blockquote class="card-blockquote">
                                ...
                                <a target="_blank" href="awareness4.php" class="btn btn-outline-secondary"><span class="fa fa-download mr-2"></span>Awareness</a>
                                <a href="level/level04/l.php" class="btn btn-outline-secondary"><span class="far fa-lightbulb mr-2"></span>Hint</a>
                                <div class="input-group mt-3">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="customRadio1_p1" name="customRadio_p1" class="custom-control-input">
                                        <label class="custom-control-label" for="customRadio1_p1" checked=false>Very Easy</label>
                ...
                <div class="col-md-4 mb-3">
                    <div class="card category_web">
                        <div class="card-header" data-target="#problem_id_5" data-toggle="collapse" aria-expanded="false" aria-controls="problem_id_5">
                            Valencia 2.0 linux challenge <span class="badge"></span> <span class="badge">50 points</span>
                        </div>
                        <div id="problem_id_5" class="collapse card-body">
                            <blockquote class="card-blockquote">
                                ...
                                <a target="_blank" href="awareness5.php" class="btn btn-outline-secondary"><span class="fa fa-download mr-2"></span>Awareness</a>
                                <a href="level05.php" class="btn btn-outline-secondary"><span class="far fa-lightbulb mr-2"></span>Hint</a>
                                <div class="input-group mt-3">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="customRadio1_p1" name="customRadio_p1" class="custom-control-input">
                                        <label class="custom-control-label" for="customRadio1_p1" checked=false>Very Easy</label>
                ...
                <div class="col-md-4 mb-3">
                    <div class="card category_web">
                        <div class="card-header" data-target="#problem_id_6" data-toggle="collapse" aria-expanded="false" aria-controls="problem_id_6">
                            Defcon 2 forensics challenge<span class="badge"></span> <span class="badge">50 points</span>
                        </div>
                        <div id="problem_id_6" class="collapse card-body">
                            <blockquote class="card-blockquote">
                                ...
                                <a target="_blank" href="awareness6.php" class="btn btn-outline-secondary"><span class="fa fa-download mr-2"></span>Awareness</a>
                                <a href="level06.php" class="btn btn-outline-secondary"><span class="far fa-lightbulb mr-2"></span>Hint</a>
                                <div class="input-group mt-3">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="customRadio1_p1" name="customRadio_p1" class="custom-control-input">
                                        <label class="custom-control-label" for="customRadio1_p1" checked=false>Very Easy</label>
                ...
                <div class="col-md-4 mb-3">
                    <div class="card category_web">
                        <div class="card-header" data-target="#problem_id_7" data-toggle="collapse" aria-expanded="false" aria-controls="problem_id_7">
                            Aikido network analysis challenge<span class="badge"></span> <span class="badge">50 points</span>
                        </div>
                        <div id="problem_id_7" class="collapse card-body">
                            <blockquote class="card-blockquote">
                                ...
                                <a target="_blank" href="awareness7.php" class="btn btn-outline-secondary"><span class="fa fa-download mr-2"></span>Awareness</a>
                                <a href="level07.php" class="btn btn-outline-secondary"><span class="far fa-lightbulb mr-2"></span>Hint</a>
                                <div class="input-group mt-3">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="customRadio1_p1" name="customRadio_p1" class="custom-control-input">
                                        <label class="custom-control-label" for="customRadio1_p1" checked=false>Very Easy</label>
                ...
                <div class="col-md-4 mb-3">
                    <div class="card category_web">
                        <div class="card-header" data-target="#problem_id_8" data-toggle="collapse" aria-expanded="false" aria-controls="problem_id_8">
                            Chernobyl 2.0 web Challenge<span class="badge"></span> <span class="badge">50 points</span>
                        </div>
                        <div id="problem_id_8" class="collapse card-body">
                            <blockquote class="card-blockquote">
                                ...
                                <a target="_blank" href="awareness8.php" class="btn btn-outline-secondary"><span class="fa fa-download mr-2"></span>Awareness</a>
                                <a href="level08.php" class="btn btn-outline-secondary"><span class="far fa-lightbulb mr-2"></span>Hint</a>
                                <div class="input-group mt-3">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="customRadio1_p1" name="customRadio_p1" class="custom-control-input">
                                        <label class="custom-control-label" for="customRadio1_p1" checked=false>Very Easy</label>
                ...
                <div class="col-md-4 mb-3">
                    <div class="card category_web">
                        <div class="card-header" data-target="#problem_id_9" data-toggle="collapse" aria-expanded="false" aria-controls="problem_id_9">
                            Epicentro reverse engineering <span class="badge"></span> <span class="badge">50 points</span>
                        </div>
                        <div id="problem_id_9" class="collapse card-body">
                            <blockquote class="card-blockquote">
                                ...
                                <a target="_blank" href="awareness9.php" class="btn btn-outline-secondary"><span class="fa fa-download mr-2"></span>Awareness</a>
                                <a href="level09.php" class="btn btn-outline-secondary"><span class="far fa-lightbulb mr-2"></span>Hint</a>
                                <div class="input-group mt-3">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="customRadio1_p1" name="customRadio_p1" class="custom-control-input">
                                        <label class="custom-control-label" for="customRadio1_p1" checked=false>Very Easy</label>
                ...
                <div class="col-md-4 mb-3">
                    <div class="card category_web">
                        <div class="card-header" data-target="#problem_id_10" data-toggle="collapse" aria-expanded="false" aria-controls="problem_id_10">
                           Hamelin exploit challenge<span class="badge"></span> <span class="badge">50 points</span>
                        </div>
                        <div id="problem_id_10" class="collapse card-body">
                            <blockquote class="card-blockquote">
                                ...
                                <a target="_blank" href="awareness10.php" class="btn btn-outline-secondary"><span class="fa fa-download mr-2"></span>Awareness</a>
                                <a href="level10.php" class="btn btn-outline-secondary"><span class="far fa-lightbulb mr-2"></span>Hint</a>
                                <div class="input-group mt-3">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="customRadio1_p1" name="customRadio_p1" class="custom-control-input">
                                        <label class="custom-control-label" for="customRadio1_p1" checked=false>Very Easy</label>
                ...
                <div class="col-md-6 mb-3">
                    <div class="card category_misc">
                        ...
                        <div id="problem_id_10" class="collapse card-body">
                            <blockquote class="card-blockquote">
                                <div style="display: flex;">
                                    <h6 class="solvers">Solvers: <span class="solver_num">76</span> &nbsp;</h6>
                                    <div class="pl-2"><canvas style="width:80px;height:20px" id="problem_id_4_chart"></canvas></div>
                                </div>
                                <p> Enter the flag in the following format: CyberHeist_CTF{flag}
                                </p>
                                <a target="_blank" href="#!" class="btn btn-outline-secondary"><span class="fa fa-download mr-2"></span>Awareness</a>
                                <a href="level10.php" class="btn btn-outline-secondary"><span class="far fa-lightbulb mr-2"></span>Hint</a>
                                <div class="input-group mt-3">
                                    <div class="custom-control custom-radio">
                ...
                <div class="col-md-6 mb-3">
                    <div class="card category_steg">
                        <div class="card-header" data-target="#problem_id_11" data-toggle="collapse" aria-expanded="false" aria-controls="problem_id_11">
                        ...
                        <div id="problem_id_11" class="collapse card-body">
                            <blockquote class="card-blockquote">
                                ...
                                <a target="_blank" href="#!" class="btn btn-outline-secondary"><span class="fa fa-download mr-2"></span>Awareness</a>
                                <a href="level11.php" class="btn btn-outline-secondary"><span class="far fa-lightbulb mr-2"></span>Hint</a>
                                <div class="input-group mt-3">
                                    <div class="custom-control custom-radio">
            ...
            <img src="/ctf/images/bg.jpg" class="level_pic" alt="Do you want to complete this level" width="150px" height="250px">
        ...
        <div class="navbar-nav ml-auto">
            ...
            <a href="login.php" class="p-3 text-decoration-none text-lightcol bold">Logout</a>
        </div>
