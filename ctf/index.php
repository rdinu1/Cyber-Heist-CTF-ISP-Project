    ...
    <div id="main">
       ...
       <!-- <div style="position: fixed;" class="glitch__img"></div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4">
                        ...
                        <button class="btn btn-outline-danger px-3 my-2 ml-0 ml-sm-1 text-left typewriter log-btn" margin="right" onclick="(function(){window.location.href='log.php'})();">
                            <h4>Login</h4>
                        </button>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-8">
                        <h1 class="display-1 bold content__title tile">CYBER<span class="color_danger">HEIST</span></h1>
        ...
        <div class="navbar-nav ml-auto">
            <a href="index.php" class="p-3 text-decoration-none text-white bold bottom-nav">Home</a>
